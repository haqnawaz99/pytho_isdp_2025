"""
Convert CHAPTER_Strings.md to DOCX with embedded images.
Run from the 1_Strings folder: python md_to_docx.py
...
MD_FILE = CHAPTER_DIR / "CHAPTER_Strings.md"
OUT_DOCX = CHAPTER_DIR / "CHAPTER_Strings.docx"
...
def main():
    ...
    doc = Document()
    doc.add_heading("Chapter: Strings in Python", 0)
